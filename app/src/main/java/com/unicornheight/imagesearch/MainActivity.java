...
public class MainActivity extends AppCompatActivity {
    ...
    FloatingActionButton selectCamera;
    ProgressBar pbLoad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectCamera = (FloatingActionButton) findViewById(R.id
                .fab);
        selectImageButton = (Button) findViewById(R.id
                .select_image_button);
        selectedImage = (ImageView) findViewById(R.id.selected_image);
        resultTextView = (TextView) findViewById(R.id.result);
        pbLoad = (ProgressBar) findViewById(R.id.pbLoading);
        hideL = (LinearLayout) findViewById(R.id.layout_id);
    ...
    private void callCloudVision(final Bitmap bitmap) throws IOException {
        ...
        new AsyncTask<Object, Void, String>() {
            ...
            protected void onPostExecute(String result) {
                ...
                hideL.setVisibility(View.INVISIBLE);
    ...
    private void getAuthToken() {
        ...
        if (mAccount == null) {
            ...
            new TokenAction(MainActivity.this, mAccount, SCOPE, REQUEST_ACCOUNT_AUTHORIZATION)
                    .execute();
        }
    }
